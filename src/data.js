...
let pokemonImg=pokemon["img"]; // "" string
let pokemonName=pokemon["name"];
let pokemonHeight=pokemon["height"];//  "" string
let pokemonId=pokemon["id"]; // number
let pokemonEgg=pokemon["egg"]; // string
...
const filterPokemonByType=(arrayObjetos8,condition)=>{ // [{},{8properties}] aqui entra un array de objetos y una condicion(es un string)
let newArrayPokemonFilterbyType=[]; 
for(let i=0; i<arrayObjetos8.length;i++){
arrayObjetos8[i];//{8 properties}
const  arrayOfStrings=arrayObjetos8[i].type; //["",""]accediendo a un array de strings
